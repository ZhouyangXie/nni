...
infer_from_inshape = {
    ...
    'Mish': lambda module_masks, mask: relu_inshape(module_masks, mask),
...
infer_from_outshape = {
    ...
    'Upsample': lambda module_masks, mask: maxpool2d_outshape(module_masks, mask),
    ...
    'LeakyReLU': lambda module_masks, mask: relu_outshape(module_masks, mask),
    'Sigmoid': lambda module_masks, mask: relu_outshape(module_masks, mask),
    'Mish': lambda module_masks, mask: relu_outshape(module_masks, mask),
